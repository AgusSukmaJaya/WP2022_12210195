            ...
            <div class="row">
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('form/register') ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="password" class="form-control form-control-user" id="paswword2" placeholder="Repeat Password" name="password2">
                                </div>
                            </div>
                        ...
                        <div class="text-center">
                            <a class="small" href="<?= base_url('form'); ?>">Already have an account? Login!</a>
                        </div>
                    </div>
                </div>
            </div>
